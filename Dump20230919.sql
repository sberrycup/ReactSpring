CREATE DATABASE  IF NOT EXISTS `java505_team1_final` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `java505_team1_final`;
...
) ENGINE=InnoDB AUTO_INCREMENT=179 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='장바구니';
...
INSERT INTO `likes` VALUES (26,3,NULL,'test'),(27,5,NULL,'test'),(29,3,NULL,'user'),(30,5,NULL,'user'),(31,3,NULL,'admin'),(32,5,NULL,'admin'),(33,40,NULL,'test'),(36,40,NULL,'user'),(37,41,NULL,'user'),(39,41,NULL,'admin'),(40,43,NULL,'user'),(42,46,NULL,'test'),(43,49,NULL,'admin'),(45,76,NULL,'test'),(46,76,NULL,'user'),(47,76,NULL,'admin');
...
) ENGINE=InnoDB AUTO_INCREMENT=424 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='쪽지 테이블(판매자에게 문의)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mail` VALUES (416,'안녕하세요','user','userName1','2023-08-25 15:38','25_user',0,0),(417,'안녕하세요','test','testEdited','2023-08-25 15:39','25_user',0,0),(418,'네','user','userName1','2023-08-25 15:39','25_user',0,0),(419,'네','user','userName1','2023-08-25 15:40','25_user',1,0),(420,'문의드려요','admin','adminName','2023-09-07 09:19','29_admin',0,0),(421,'네!!','testuser1','판매자','2023-09-07 09:19','29_admin',0,0),(422,'123','testuser2','구매자','2023-09-07 09:50','29_testuser2',0,0),(423,'dasd','testuser1','판매자','2023-09-07 09:50','29_testuser2',0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=358 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자가 도서 구입시 생성되는 정보(주문번호 등)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='판매자가 등록한 도서 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-19  9:35:01
